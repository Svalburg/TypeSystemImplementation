...
class RuleTest: public ::testing::Test
{
	...
	void SetUp()
	{
		...
		func1 = new ComponentFunction("test1", "test", "x", new RuleSkip(), new RuleConst("0"), 1);
		func2 = new ComponentFunction("test2", "test", "x", new RuleSkip(), new RuleConst("0"), 1);
		func3 = new ComponentFunction("test3", "test", "x", new RuleSkip(), new RuleConst("0"), 1);
